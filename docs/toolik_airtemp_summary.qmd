...
toolik_chlorophyll_plot <- ggplot(data = toolik_chlorophyll,
       aes(x = depth, y = active_chl_a_ug_l)) + geom_point()
theme_minimal() +
  labs(title = "Toolik Lake Chlorophyll a concentration", X = "Depth (m)", 
       y = "Chlorophyll a concentration (micrograms per liter)")

toolik_chlorophyll_plot

# save plot
ggsave(here::here("figs", "toolik_chlorophyll_polot.png"), height = 6, width = 7)
